...
## 重要ルール（ハード制約 — 必ず守る）
1. **堀田は原則毎日・全枠に入れる。ただし山田英照がその枠に入っている場合のみ、堀田は入れなくてよい（休ませる）**。つまり「山田がいる枠 → 山田＋堀田以外のスタッフ」「山田がいない枠 → 堀田は必ず入る」。高培勛は毎日出勤の制約はない
...
7. 勤務日数を公平に配分
8. 希望シフトをできるだけ尊重
9. 堀田は原則毎日全枠出勤。山田英照がその枠に入る場合のみ、堀田を外して「山田＋堀田以外」の組み合わせにする
